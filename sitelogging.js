...
let GlblModule = (function () {
    ...
    function log(level, msg) {
        ...
        switch (level) {
            case 1:
                console.log(`LOG: ${timestmp} - ${msg}`);
                break;
            case 2:
                console.info(`INFO: ${timestmp} - ${msg}`);
                break;
            case 3:
                console.warn(`WARN: ${timestmp} - ${msg}`);
                break;
            case 4:
                console.error(`ERROR: ${timestmp} - ${msg}`);
                break;
            case 5:
                console.trace(`TRACE: ${timestmp} - ${msg}`);
                break;
        }
    }
    ...
    let img_error_handler = function (message, source, lineno, colno, error) {        
        log(3,`No image source for ${message.target.currentSrc}`)
        this.onerror = null;
    ...
    function buildProductList(products) {
        ...
        log(2,"entering buildProductList()");
